...
// import { onCloseDrawerAddResume } from "@/store/slices/drawerSlice";
...
import ResumeUploadProgress from "../upload/ResumeUploadProgress";
...
interface DrawerAddResumeProps {
  ...
  drawerAddResumeOpen: boolean;
}

const DrawerAddMultipleResume = ({
  onSelectFile,
  drawerAddResumeOpen,
  onCloseDrawer,
        ...
        <button
          ...
          onClick={() => {
            if (item.file_id && onSelectFile) {
              onSelectFile(item);
              // dispatch(onCloseDrawerAddResume());
            }
          }}
        >
  ...
  }, [fileList, filterText, onSelectFile]);
  ...
  return (
    <DrawerDrag open={drawerAddResumeOpen} onClose={closeDrawer}>
      <BoxContent>
...
export default DrawerAddMultipleResume;
